        ...
        <div class="container-fluid">
            ...
            <div class="row justify-content-center mt-3">
                ...
                <table class="table caption-top table-striped table-hover my-5">
                    ...
                    <thead class="">
                        <tr>
                            <th class="text-center">年度<br/>員工<br/>員工編號</th><th class="text-center">病假(天數/時數/總時數)<br/>事假(天數/時數/總時數)<br/>公假(天數/時數/總時數)</th><th class="text-center">特休假(天數/時數/總時數)<br/>婚假(天數/時數/總時數)<br/>喪假(天數/時數/總時數)</th><th class="">家庭照顧假(天數/時數/總時數)<br/>生理假(天數/時數/總時數)<br/>陪產假(天數/時數/總時數)</th><th class="">產檢假(天數/時數/總時數)<br/>產假(天數/時數/總時數)<br/>其他(天數/時數/總時數)</th><th class="">換休(天數/時數/總時數)<br/>公傷病假(天數/時數/總時數)</th>
                        </tr>
                    </thead>
