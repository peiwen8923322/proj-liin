<?php
    ...
    if (isset($_POST['submit'])) { //按下"送出 / 暫存"按鈕的處理動作
        ...
        // echo "請假啟始日：$arrCurRecord[begindate]<br/>";
        // echo "請假截止日：$arrCurRecord[enddate]<br/>";
        // echo "相差幾秒：".(strtotime($arrCurRecord['enddate']) - strtotime($arrCurRecord['begindate']))."<br/>";
        // echo "相差幾小時：".((strtotime($arrCurRecord['enddate']) - strtotime($arrCurRecord['begindate'])) / 3600)."<br/>";
