            ...
            <div class="row justify-content-center mt-3">
                ...
                <div class="row">
                    <div class="col">
                        ...
                        $htmlTags[html_year]
                        <!--<input type="text" class="form-control" id="year" name="year" value="{$arrQryFld['year']}" placeholder="請輸入年度" title="請輸入年度" autofocus>-->
                    </div>
                    <div class="col">
                ...
                <table class="table caption-top table-striped table-hover my-5">
                    ...
                    <thead class="">
                        <tr>
                            <th class="col-1 text-center">功能</th><th class="">審核狀態</th><th class="text-center">年度</th><th class="text-center">機構</th>><th class="text-center">員工</th><th class="text-center">代理人</th><th class="text-center">假別</th><th class="col-2">請假事由</th><th class="text-center">假單送出時間</th><th class="text-center">請假啟始日</th><th class="text-center">請假截止日</th><th class="text-center">請假天數<br/>請假時數</th>
                        </tr>
                    </thead>
