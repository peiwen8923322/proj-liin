...
class MYPDF extends TCPDF {
	...
	public function Header() {
        ...
        $this->Cell(0, 0, "機構：{$this->arrEmp['cmpapl']}", 0, false, 'L', 0, '', 0, false, 'M', 'M');
        $this->Cell(0, 0, "列印人：{$this->arrEmp['empapl']}", 0, true, 'R', 0, '', 0, false, 'M', 'M');
        $this->Ln();
        $this->Cell(0, 0, "員工：{$this->arrEmp['empapl']}", 0, false, 'L', 0, '', 0, false, 'M', 'M');
        $this->Cell(0, 0, '列印日期：'.date("Y-m-d H:i", time()), 'B', true, 'R', 0, '', 0, false, 'M', 'M');
	}
...
// $htmlQryResult = $obj_holiday->PrtPDFByQry($obj_holiday->rtnQryResults($obj_holiday->SQL), $tbl);
...
//     <thead>
//         <tr>
//             <th>審核狀態</th><th>年度</th><th>員工</th><th>代理人</th><th>假別</th><th>請假事由</th><th>假單送出時間</th><th>請假啟始日</th><th>請假截止日</th><th>請假天數</th><th>請假時數</th>
//         </tr>
//     </thead>
//     $htmlQryResult
// </table>
