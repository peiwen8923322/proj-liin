        ...
        <div class="container-fluid">
            ...
            <div class="row">
                <div class="col-10">
                    ...
                    <div class="row">
                        <div class="col-2 text-end fw-bolder"><label for="hldsdays" class="form-label">請假天數：<br/>(單位：天)</label></div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-2 text-end fw-bolder"><label for="frmformcode" class="form-label">審核狀態：</label></div>
                    ...
                    <div class="row justify-content-center my-3">
                        <input type="submit" class="col-1 btn btn-primary" name="submit" value="送出">&nbsp;&nbsp;<input type="submit" class="col-1 btn btn-outline-primary" name="submit" value="暫存">
                    </div>
                </div>
