        ...
        <div class="container-fluid">
            ...
            <div class="row justify-content-center mt-3">
                ...
                <table class="table caption-top table-striped table-hover my-5">
                    ...
                    <thead class="">
                        <tr>
                            <th class="col-1 text-center">功能</th><th class="">審核狀態</th><th class="text-center">年度</th><th class="text-center">員工</th><th class="text-center">代理人</th><th class="text-center">假別</th><th class="col-3">請假事由</th><th class="text-center">假單送出時間</th><th class="text-center">請假啟始日</th><th class="text-center">請假截止日</th><th class="text-center">請假天數</th><th class="text-center">請假時數</th>
                        </tr>
                    </thead>
