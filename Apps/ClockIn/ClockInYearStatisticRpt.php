...
class MYPDF extends TCPDF {
	...
	public function Header() {
		...
		// Title
		$this->Cell(0, 0, '員工刷卡統計清單', 0, true, 'C', 0, '', 0, false, 'M', 'M');
        $this->Ln();
...
$pdf->setAuthor('徐培文');
$pdf->setTitle('員工刷卡統計清單');
$pdf->setSubject('員工刷卡統計清單');
...
// $obj_clockin->SQL = $obj_clockin->SQLSelect.$obj_clockin->SQLFrom.$obj_clockin->SQLWhere.$obj_clockin->SQLGroupBy.$obj_clockin->SQLOrderBy;
// $obj_clockin->intStartPos = 1;
// $obj_clockin->intEndPos = count($arrData);
$pdf->writeHTML($obj_clockin->PrtPDFSttQry($arrData, $tbl), true, false, true, false, '');

// ---------------------------------------------------------

//Close and output PDF document
$pdf->Output('ClockInYearStatisticRpt.pdf', 'I');
