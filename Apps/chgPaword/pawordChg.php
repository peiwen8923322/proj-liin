        ...
        <!--  header區塊  -->
         <header>
            <div class="d-flex flex-row text-white" style="background-color: #3E7050;">
                ...
                <h6 class="col-auto text-end">使用者：<?php echo $_SESSION['login_emp']['empapl'] ?> / 帳號：<?php echo $_SESSION['login_emp']['empcode'] ?> / 登入日期：<?php echo  $_SESSION['login_time'] ?> &nbsp;&nbsp;<input type="button" class="btn btn-outline-light" name="logout" value="登出"></h6>
            </div>        
        </header>
        
        <?php include_once "../../Require/navigation.php"; //Nav區塊 下拉選單(路徑大小寫有區分) ?>

    <!-- main區塊 -->
    <main>
        <h5 class="alert alert-success text-primary fw-bold">狀態列：<?php echo $strStsMsg ?></h5>
        ...
        <form method="post" action="" id="form1" name="form1">
            <div class="container-fluid">
                ...
                <div class="row justify-content-center my-3">
                    <input type="submit" class="col-1 btn btn-primary me-3" id="login" name="submit" value="確定">
