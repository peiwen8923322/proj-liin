<?php
    ...
    */
    ...
    if(isset($_POST['query'])){ //按下"查詢"按鈕的處理動作
        ...
        $obj_egress->SQLWhere .= " AND formstate = 15 AND cls = '加班' AND (mngrformcode = '{$tbl['emp']['formcode']}' OR cifformcode = '{$tbl['emp']['formcode']}') "; // 一般單位主管 OR 主任
...
echo <<<_html
    ...
    <main>
        ...
        <h4 class="text-secondary text-decoration-underline my-3"><b>審核員工加班清單</b></h4>
        <div class="row justify-content-center mt-3">
            ...
            <table class="table caption-top table-striped table-hover my-5">
                ...
                <thead class="">
                    <tr>
                        <th class="col-sm-1 text-center">功能</th><th class="">審核狀態</th><th class="">機構</th><th class="text-center">員工</th><th class="text-center">年度</th><th class="col-sm-3">加班事由</th><th class="text-center">加班起始日</th><th class="text-center">加班截止日</th><th class="text-center">加班時數</th><th class="text-center">加班者簽核時間</th>
                    </tr>
                </thead>
