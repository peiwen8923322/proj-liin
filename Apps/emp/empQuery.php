    ...
    <main>
        ...
        <div class="row justify-content-center mt-3">
            ...
            <table class="table caption-top table-striped table-hover my-5">
                ...
                <thead class="">
                    <tr>
                        <th class="col-sm-1 text-center">功能</th><th class="col-sm-1">機構</th><th class="col-sm-1 text-center">員工姓名<br/>員工編號</th><th class="col-sm-1 text-center">身份證字號<br/>生日</th><th class="col-sm-1 text-center">到職日<br/>年資</th><th class="col-sm-1 text-center">員工角色<br/>單位主管角色</th><th class="col-sm-1 text-center">代理人<br/>單位主管</th><th class="col-sm-1 text-center">人事主管<br/>會計主管</th><th class="col-sm-1 text-center">主任</th>
                    </tr>
                </thead>
