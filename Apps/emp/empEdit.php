        ...
        <div class="container-fluid">
            ...
            <div class="row">
                <div class="col-9">
                    ...
                    <div class="row">
                        <div class="col-2 text-end fw-bolder"><label for="empcode" class="form-label">員工編號：<br/>(必填)</label></div>
                        ...
                        <div class="col-2 text-end fw-bolder"><label for="empidno" class="form-label">身分證字號/居留證：<br/>(必填)</label></div>
                    ...
                    <div class="row my-3">
                        ...
                        <div class="col gy-2">$htmlTags[html_ntn]</div>
                        <div class="col-2 text-end fw-bolder"><label for="country" class="form-label">國家：</label></div>
                        <div class="col gy-2">$htmlTags[html_country]</div>
                    </div>
                    <div class="row">
                    ...
                    <div class="row">
                        ...
                        <div class="col"><input class="form-control" style="height: 1.6cm;" type="date" id="takeofcdate" name="takeofcdate" title="請輸入到職日" value="$htmlTags[html_takofcdate]" required></div>
                    </div>
                    <div class="row">
                        <div class="col-2 text-end fw-bolder"><label for="levofcdate" class="form-label">離職日：</label></div>
                        <div class="col"><input class="form-control" style="height: 1.6cm;" type="date" id="levofcdate" name="levofcdate" title="請輸入離職日" value="$htmlTags[html_levofcdate]"></div>
                        <div class="col-2 text-end fw-bolder"><label for="atwrksta" class="form-label">在職狀況：</label></div>
                        <div class="col">$htmlTags[html_atwrksta]</div>
                    </div>
                    <div class="row">
                        ...
                        <div class="col"><input type="text" class="form-control" style="height: 1.6cm;" id="curhrs" name="curhrs" title="請輸入目前可特休時數" value="$htmlTags[html_curhrs]" required></div>
                    </div>
                    <div class="row my-3">
                        <div class="col-2 text-end fw-bolder"><label for="othwrk_01" class="form-label">相關工作：</label></div>
                        <div class="col">$htmlTags[html_othwrk]</div>
                    </div>
                    <div class="row my-3">
                        <div class="col-2 text-end fw-bolder"><label for="lang_01" class="form-label">常用語言：</label></div>
                        <div class="col">$htmlTags[html_language]</div>
                    </div>
                    <div class="row my-3">
                ...
                <div class="row justify-content-center my-3">
                    <input type="submit" id="submit" name="submit" value="確定" class="col-1 btn btn-primary">&nbsp;&nbsp;<input type="button" id="cancel" name="cancel" value="關閉" class="col-1 btn btn-outline-primary">
                </div>
            </div>
        </div>
    </main>    
