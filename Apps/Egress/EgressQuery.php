<?php
    ...
    */
    ...
    if(isset($_POST['query'])){ //按下"查詢"按鈕的處理動作
        ...
        $obj_egress->SQLWhere .= " AND formstate = 15 AND cls = '外出' AND empformcode = '{$_SESSION['login_emp']['formcode']}' ";
        ...
        header("location: EgressEdit.php");
        exit();
...
echo <<<_html
    ...
    <main>
        ...
        <h4 class="text-secondary text-decoration-underline my-3"><b>查詢員工外出資料</b></h4>
