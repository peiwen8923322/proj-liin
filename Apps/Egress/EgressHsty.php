...
echo <<<_html
    ...
    <main>
        <div class="row"><h5 class="alert alert-success text-primary fw-bold">狀態列：$strStsMsg</h5></div>
            <h4 class="text-secondary text-decoration-underline my-3"><b>查詢員工外出歷史資料</b></h4>
            <div class="row justify-content-center mt-3">
                ...
                <table class="table caption-top table-striped table-hover my-5">
                    ...
                    <thead class="">
                        <tr>
                            <th class="text-center">審核狀態</th><th class="">機構</th><th class="text-center">員工</th><th class="text-center">年度</th><th class="col-sm-3">外出事由</th><th class="text-center">外出起始日</th><th class="text-center">外出截止日</th><th class="text-center">外出時數</th><th class="text-center">外出者簽核時間</th>
                        </tr>
                    </thead>
