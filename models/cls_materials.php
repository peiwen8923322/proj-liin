...
/*
cls_materials 耗材檔(品項檔)
*/

class cls_materials extends cls_models
{
    //variable members
...
_sql;
    ...
    */
    ...
    /*
     ...
     $splrcode: 供應商代碼
     */
    function getListBySupplier($splrcode){
        //Begin
    ...
    $mtrlcode: 品項代碼
    */
    public function getRecdBySplrcodeMtrlcode(string $splrcode, string $mtrlcode)
    {
        // Begin
        $this->SQL = "SELECT * FROM $this->self_table WHERE 1 AND formstate = 15 AND splrcode = '$splrcode' AND mtrlcode = '$mtrlcode'";
